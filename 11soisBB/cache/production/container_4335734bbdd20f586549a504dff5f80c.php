...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000020f34c0e000000006f340b44(
...
class phpbbtemplatetwiglexer_0000000020f34c0e000000006f340b44 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d963648b5029333354252 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d963648b5030214598823 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d963648b500d460833262 = array(
    ...
    {
        $this->initializer5d963648b5030214598823 && ($this->initializer5d963648b5030214598823->__invoke($valueHolder5d963648b5029333354252, $this, 'set_environment', array('env' => $env), $this->initializer5d963648b5030214598823) || 1) && $this->valueHolder5d963648b5029333354252 = $valueHolder5d963648b5029333354252;

        return $this->valueHolder5d963648b5029333354252->set_environment($env);
    }
    ...
    {
        $this->initializer5d963648b5030214598823 && ($this->initializer5d963648b5030214598823->__invoke($valueHolder5d963648b5029333354252, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d963648b5030214598823) || 1) && $this->valueHolder5d963648b5029333354252 = $valueHolder5d963648b5029333354252;

        return $this->valueHolder5d963648b5029333354252->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d963648b5030214598823 && ($this->initializer5d963648b5030214598823->__invoke($valueHolder5d963648b5029333354252, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d963648b5030214598823) || 1) && $this->valueHolder5d963648b5029333354252 = $valueHolder5d963648b5029333354252;

        return $this->valueHolder5d963648b5029333354252->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d963648b5030214598823 = $initializer;
    }
    ...
    {
        $this->initializer5d963648b5030214598823 && ($this->initializer5d963648b5030214598823->__invoke($valueHolder5d963648b5029333354252, $this, '__get', array('name' => $name), $this->initializer5d963648b5030214598823) || 1) && $this->valueHolder5d963648b5029333354252 = $valueHolder5d963648b5029333354252;

        if (isset(self::$publicProperties5d963648b500d460833262[$name])) {
            return $this->valueHolder5d963648b5029333354252->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d963648b5029333354252;
    ...
    {
        $this->initializer5d963648b5030214598823 && ($this->initializer5d963648b5030214598823->__invoke($valueHolder5d963648b5029333354252, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d963648b5030214598823) || 1) && $this->valueHolder5d963648b5029333354252 = $valueHolder5d963648b5029333354252;
    ...
    {
        $this->initializer5d963648b5030214598823 && ($this->initializer5d963648b5030214598823->__invoke($valueHolder5d963648b5029333354252, $this, '__isset', array('name' => $name), $this->initializer5d963648b5030214598823) || 1) && $this->valueHolder5d963648b5029333354252 = $valueHolder5d963648b5029333354252;
    ...
    {
        $this->initializer5d963648b5030214598823 && ($this->initializer5d963648b5030214598823->__invoke($valueHolder5d963648b5029333354252, $this, '__unset', array('name' => $name), $this->initializer5d963648b5030214598823) || 1) && $this->valueHolder5d963648b5029333354252 = $valueHolder5d963648b5029333354252;
    ...
    {
        $this->initializer5d963648b5030214598823 && ($this->initializer5d963648b5030214598823->__invoke($valueHolder5d963648b5029333354252, $this, '__clone', array(), $this->initializer5d963648b5030214598823) || 1) && $this->valueHolder5d963648b5029333354252 = $valueHolder5d963648b5029333354252;

        $this->valueHolder5d963648b5029333354252 = clone $this->valueHolder5d963648b5029333354252;
    }

    public function __sleep()
    {
        $this->initializer5d963648b5030214598823 && ($this->initializer5d963648b5030214598823->__invoke($valueHolder5d963648b5029333354252, $this, '__sleep', array(), $this->initializer5d963648b5030214598823) || 1) && $this->valueHolder5d963648b5029333354252 = $valueHolder5d963648b5029333354252;

        return array('valueHolder5d963648b5029333354252');
    }
    ...
    {
        return $this->initializer5d963648b5030214598823;
    }
    ...
    {
        return $this->initializer5d963648b5030214598823 && ($this->initializer5d963648b5030214598823->__invoke($valueHolder5d963648b5029333354252, $this, 'initializeProxy', array(), $this->initializer5d963648b5030214598823) || 1) && $this->valueHolder5d963648b5029333354252 = $valueHolder5d963648b5029333354252;
    }
    ...
    {
        return null !== $this->valueHolder5d963648b5029333354252;
    }
    ...
    {
        return $this->valueHolder5d963648b5029333354252;
    }
